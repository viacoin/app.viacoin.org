        ...
        <div class="container">
          <div class="banner-inner">
            <div class="banner-text">
              <h1><strong>Viacoin transitions into a sovereign validity-proof zkEVM rollup for Bitcoin</strong></h1>
            <div class="banner-ctas">
              <a class="banner-link secondary" href="https://docs.onvia.org/?utm_source=viacoin.org&amp;utm_medium=referral&amp;utm_campaign=announcement-2025-08&amp;utm_content=banner-secondary">Read the new Via L2 Gitbook Documentation</a>
              ...
              <a class="banner-link primary" href="https://buildonvia.org/?utm_source=viacoin.org&amp;utm_medium=referral&amp;utm_campaign=announcement-2025-08&amp;utm_content=banner-primary">Visit the new site</a>
            </div>
              ...
              <p>A lot has changed over the past decade as Bitcoin has opened up potential layer 2 solutions that could extend its capabilities without bloating the chain.</p>
              <p>Take Taproot, which became active in 2021. It brought better scripting and multi-signature efficiency, making more complex applications possible. The Lightning Network is made possible by CheckLockTimeVerify, which shows that Layer 2 can facilitate fast and inexpensive transactions.</p>
              ...
              <p>Rollups, which process transactions off-chain and settle them on Bitcoin instead of Ethereum, could keep things fast and cheap without sacrificing security or bloating the chain for everyone.</p>
              <p>Then we started to wonder. Why keep pushing when we could build on Bitcoin itself? Running an altcoin based on Bitcoin, while Bitcoin's ecosystem started to expand slowly. Viacoin gave us a head start, allowing us to test ideas like CLTV and ClearingHouse, but Bitcoin's security, hash power, and user base were unparalleled.</p>
              <p>Ultimately, we decided to build Via (2.0) as our own Bitcoin Layer 2 solution.By using zero-knowledge (ZK) proofs and anchoring state commitments to Bitcoin.</p>
              ...
              <p>By anchoring our sovereign rollup's state root into Bitcoin, Via inherits Bitcoin's finality guarantees and Proof-of-Work security, echoing the spirit of AuxPow, without bloating Bitcoin's UTXO set or incurring massive fees every batch.</p>
              ...
              <p>Want smart contracts? We can have them, echoing the spirit of both Counterparty and ClearingHouse. We'll use Taproot for multi-signatures and inscriptions for metadata.</p>
              <p>EVM-Compatible? Sure. Port existing dApps? Yes</p>
              ...
              <p>A Layer 2 for Via would enable us to scale up, as we are not just building a new layer on top of Bitcoin, but also an entire DeFi ecosystem. Bringing EVM smart contracts to Bitcoin.</p>
